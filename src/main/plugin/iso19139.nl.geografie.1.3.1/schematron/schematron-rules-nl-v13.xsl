...
<xsl:template match="/">
      <svrl:schematron-output xmlns:geonet="http://www.fao.org/geonetwork"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">Validatie tegen het Nederlands metadata profiel op ISO 19115 voor geografie v 1.3.1</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:param name="lowercase" select="'abcdefghijklmnopqrstuvwxyz'"/>
   ...
   <!--PATTERN DutchMetadataCoreSetValidatie tegen het Nederlands metadata profiel op ISO 19115 voor geografie v 1.3.1-->
<svrl:text xmlns:geonet="http://www.fao.org/geonetwork"
              xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Validatie tegen het Nederlands metadata profiel op ISO 19115 voor geografie v 1.3.1</svrl:text>
   ...
   <xsl:variable name="conformity_Spec_Title_Exsists"
	  ...
	  <!--RULE -->
<xsl:template match="/gmd:MD_Metadata" priority="1009" mode="M7">
